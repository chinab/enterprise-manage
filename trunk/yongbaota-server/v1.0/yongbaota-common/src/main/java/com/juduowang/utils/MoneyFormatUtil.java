...
public class MoneyFormatUtil {
	...
	private static String amountFormat(Double d) {
	...
	public static String convert(String amount) throws IllegalArgumentException {
		if (amount == null || amount.equals("")) {
			throw new IllegalArgumentException("输入金额 is null.");
		}
		// 去掉分隔符
		amount = amount.replace(",", "");

		amount = amountFormat(Double.valueOf(amount));
	...
	public static void main(String[] args) {
		// log4j?
		System.out.println(convert("111234567890.00"));
		/*
