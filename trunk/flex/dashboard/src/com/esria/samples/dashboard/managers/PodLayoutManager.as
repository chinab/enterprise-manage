...
public class PodLayoutManager extends EventDispatcher
{
	...
	private static const POD_GAP:Number = 8;				// The vertical and horizontal gap between pods.
	...
	private static const TASKBAR_PADDING_TOP:Number = 8;	// The gap between the taskbar and the bottom of the last row of pods.
	private static const PADDING_RIGHT:Number = 4;			// The right padding within the container when laying out pods.
