...
internal class _AccountDTOEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("createTime", "modifyBy", "status", "isForbidden", "password", "createBy", "id", "message", "accountCode", "username", "email", "address", "accountType", "companyId", "displayName", "modifyTime", "telephone", "mobile");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("createTime", "modifyBy", "status", "isForbidden", "password", "createBy", "id", "message", "accountCode", "username", "email", "address", "accountType", "companyId", "displayName", "modifyTime", "telephone", "mobile");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("createTime", "modifyBy", "status", "isForbidden", "password", "createBy", "id", "message", "accountCode", "username", "email", "address", "accountType", "companyId", "displayName", "modifyTime", "telephone", "mobile");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("createTime", "modifyBy", "status", "isForbidden", "password", "createBy", "id", "message", "accountCode", "username", "email", "address", "accountType", "companyId", "displayName", "modifyTime", "telephone", "mobile");
