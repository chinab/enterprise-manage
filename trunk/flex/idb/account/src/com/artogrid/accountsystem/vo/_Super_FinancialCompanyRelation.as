 ...
 * of this value object you may modify the generated sub-class of this class - FinancialCompanyRelation.as.
 */
...
[ExcludeClass]
public class _Super_FinancialCompanyRelation extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        flash.net.registerClassAlias("com.artogrid.service.m1.persistant.idblogin.FinancialCompanyRelation", cz);
    }
    ...
    model_internal var _dminternal_model : _FinancialCompanyRelationEntityMetadata;
    ...
    public function _Super_FinancialCompanyRelation()
    {
        _model = new _FinancialCompanyRelationEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _FinancialCompanyRelationEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _FinancialCompanyRelationEntityMetadata) : void
    {
        var oldValue : _FinancialCompanyRelationEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
