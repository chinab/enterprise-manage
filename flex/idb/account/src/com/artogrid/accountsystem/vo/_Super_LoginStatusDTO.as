 ...
 * of this value object you may modify the generated sub-class of this class - LoginStatusDTO.as.
 */
...
[ExcludeClass]
public class _Super_LoginStatusDTO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        flash.net.registerClassAlias("com.artogrid.service.m1.vo.idblogin.LoginStatusDTO", cz);
    }
    ...
    model_internal var _dminternal_model : _LoginStatusDTOEntityMetadata;
    ...
    public function _Super_LoginStatusDTO()
    {
        _model = new _LoginStatusDTOEntityMetadata(this);
    ...
    public function set activation(value:String) : void
    {
        var oldValue:String = _internal_activation;
        if (oldValue !== value)
        {
            _internal_activation = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "activation", oldValue, _internal_activation));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _LoginStatusDTOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _LoginStatusDTOEntityMetadata) : void
    {
        var oldValue : _LoginStatusDTOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
