...
internal class _LoginStatusDTOEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("id", "accountId", "token", "status", "server", "activation", "ip", "clientType");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "accountId", "token", "status", "server", "activation", "ip", "clientType");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "accountId", "token", "status", "server", "activation", "ip", "clientType");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("id", "accountId", "token", "status", "server", "activation", "ip", "clientType");
