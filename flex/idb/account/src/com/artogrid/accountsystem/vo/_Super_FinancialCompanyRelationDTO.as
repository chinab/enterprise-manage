 ...
 * of this value object you may modify the generated sub-class of this class - FinancialCompanyRelationDTO.as.
 */
...
[ExcludeClass]
public class _Super_FinancialCompanyRelationDTO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        flash.net.registerClassAlias("com.artogrid.service.m1.vo.idblogin.FinancialCompanyRelationDTO", cz);
    }
    ...
    model_internal var _dminternal_model : _FinancialCompanyRelationDTOEntityMetadata;
    ...
    private var _internal_mappingId : String;
    private var _internal_modifyBy : String;
    private var _internal_financialCompanyId : String;
    ...
    public function _Super_FinancialCompanyRelationDTO()
    {
        _model = new _FinancialCompanyRelationDTOEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get financialCompanyId() : String
    {
        return _internal_financialCompanyId;
    }
    ...
    public function set mappingId(value:String) : void
    {
        var oldValue:String = _internal_mappingId;
        if (oldValue !== value)
        {
            _internal_mappingId = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "mappingId", oldValue, _internal_mappingId));
        }
    }
    ...
    public function set financialCompanyId(value:String) : void
    {
        var oldValue:String = _internal_financialCompanyId;
        if (oldValue !== value)
        {
            _internal_financialCompanyId = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "financialCompanyId", oldValue, _internal_financialCompanyId));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _FinancialCompanyRelationDTOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _FinancialCompanyRelationDTOEntityMetadata) : void
    {
        var oldValue : _FinancialCompanyRelationDTOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
