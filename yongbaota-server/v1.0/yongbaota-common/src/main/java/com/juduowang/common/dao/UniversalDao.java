...
/**
 * 数据访问对象(DAO)接口 Data Access Object (DAO) interface.
 * 与GenericDao不同，GenericDao是为了subclassing，被命名为Generic是因为： 1)它是相关普遍的功能，
 * 2）在Java5中，"Generic"一词的意义，使用了泛化实现这个类，不是为了subclassing.
 * 
 ...
 * @author zhuqianjin
 * @version 3.0
 * @see cn.rtdata.common.dao.GenericDao
 */
